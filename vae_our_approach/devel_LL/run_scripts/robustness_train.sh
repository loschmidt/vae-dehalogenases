...
python3 train.py --Pfam_id ${UPDIR} --output_dir ${TARGET} --stats --in_file ./results/PF00561/MSA/identified_targets_msa.fa --num_epoch 59000 --ref P59336_S14 --weight_decay 0.0 --C ${C} --layers ${L} --dimensionality ${D} --model_name ${NAME} --K 10 --robustness_train

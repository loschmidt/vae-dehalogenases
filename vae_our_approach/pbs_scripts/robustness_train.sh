...
EXPERIMENT=trainValidation #sequenceGen
EXPDIR=simple
L=299
D=2
C=2
...
python3 train.py --exp_dir ${EXPDIR} --experiment ${EXPERIMENT} --stats --in_file ./results/PF00561/MSA/identified_targets_msa.fa --num_epoch 16700 --query P59336_S14 --weight_decay 0.0 --C ${C} --layers ${L} --dimensionality ${D} --model_name ${NAME} --K 5 --robustness_train
